...
import { buscarVideos } from '../api/youtube'; // você pode ter um arquivo separado para requisições
...
const estilos = StyleSheet.create({
  ...
  containerPesquisa: {
    ...
    padding: 10, backgroundColor: '#6200ee', borderRadius: 8, margin: 20,
  },
  entrada: {
    height: 40, flex: 1, backgroundColor: '#fff', borderRadius: 4,
    paddingHorizontal: 10, marginRight: 10,
  },
  botao: {
    backgroundColor: '#03dac5', paddingVertical: 10,
    paddingHorizontal: 20, borderRadius: 4,
  },
  textoBotao: { color: '#fff', fontWeight: 'bold' },
  scrollView: { flex: 1, paddingHorizontal: 20 },
  containerVideo: {
    marginBottom: 20, backgroundColor: '#fff', borderRadius: 8,
    padding: 15, elevation: 5,
  },
  tituloVideo: { fontSize: 18, fontWeight: 'bold', marginBottom: 10 },
  webview: { width: '100%', aspectRatio: 16 / 9 },
});
